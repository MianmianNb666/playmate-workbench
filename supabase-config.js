...
if(typeof window!=="undefined" && !window.__paiMiniPrepaidSectionScheduled){
  ...
  const loadManager=async()=>{
    ...
    try{
      ...
      const presets=await import("./prepaid-presets-safe.js?v=20260925-shopguard1");
      ...
      const unified=await import("./prepaid-unified-safe.js?v=20260925-shopguard1");
...
if(typeof window!=="undefined" && !window.__paiMiniCustomerPrepaidBadgesScheduled){
  ...
  const startBadges=async()=>{
    ...
    badgesStarted=true;
    try{
      const mod=await import("./customer-prepaid-badge-safe.js?v=20260924-customertotal2");
...
if(typeof window!=="undefined" && !window.__paiMiniBossWalletScheduled){
  ...
  const startBossWallet=async()=>{
    ...
    walletStarted=true;
    try{
      await import("./boss-wallet.js?v=20260925-shopguard1");
    }catch(error){
      walletStarted=false;
